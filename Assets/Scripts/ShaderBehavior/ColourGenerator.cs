...
public class ColourGenerator
{
    ...
    {
        float height = (pointOnUnitSphere.y + 1) / 2f;
        height += (biomeNoisefilter.Evaluate(pointOnUnitSphere) - settings.biomeColourSettings.noiseOffset) * settings.biomeColourSettings.noiseStrength;
        float biomeIndex = 0;
        ...
        {
            float dst = height - settings.biomeColourSettings.biomes[i].startHeight;
